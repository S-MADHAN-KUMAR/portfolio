...
export function TubesBackground({ 
  ...
  useEffect(() => {
    ...
    const initTubes = async () => {
      ...
      try {
        // Use eval to bypass Turbopack's static analysis of the remote import
        // @ts-ignore
        const module = await eval(`import('https://cdn.jsdelivr.net/npm/threejs-components@0.0.19/build/cursors/tubes1.min.js')`);
